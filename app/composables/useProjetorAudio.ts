...
export type LoopNome = 'lobby' | 'confrontos' | 'apostas' | 'jogo' | 'standby' | 'campeao'
...
export function useProjetorAudio() {
  ...
  return { ativo, mudo, ativar, alternarMudo, tocarLoop, tocarStinger }
}
